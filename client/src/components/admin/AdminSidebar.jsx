...
const menuItems = [
  ...
  { label: "Nhật ký chatbot", to: "/admin/chatbot-logs", icon: <ChatbotIcon /> },
  { label: "Chat hỗ trợ", to: "/admin/support-chat", icon: <SupportChatIcon /> },
...
function AdminSidebar() {
  return (
    <aside className="hidden h-screen w-[260px] shrink-0 border-r border-slate-200 bg-white lg:flex lg:flex-col">
