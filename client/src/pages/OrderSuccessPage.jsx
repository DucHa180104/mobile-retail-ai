    ...
    <main className="px-4 py-8 sm:px-5 lg:px-6">
      <div className="mx-auto flex min-h-[60vh] max-w-4xl items-center justify-center">
        <section className="w-full rounded-[2rem] border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-12">
          ...
          <span className="mt-7 inline-flex rounded-full bg-blue-50 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-blue-700">
            Đơn hàng hoàn tất
          </span>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-slate-500">
            Cảm ơn bạn đã mua hàng. Cửa hàng sẽ liên hệ xác nhận đơn trong thời gian sớm nhất.
          </p>
          ...
          {orderSummary ? (
            <div className="mx-auto mt-8 max-w-2xl rounded-2xl bg-slate-50 px-5 py-5 text-left">
              ...
              />
              <SummaryRow label="Địa chỉ giao hàng" value={formatShippingAddress(shippingInfo)} />
              <SummaryRow
