...
const categoriesList = [
    ...
    { label: "Máy tính bảng", to: "/tablets", active: true },
    ...
    <label className="flex cursor-pointer items-center justify-between py-1 text-xs text-slate-600 transition hover:text-slate-900">
      <div className="flex items-center gap-2.5">
        <input
          ...
          checked={checked}
          onChange={onChange}
          className="h-4 w-4 rounded border-slate-300 text-slate-990 accent-slate-990 focus:ring-0 focus:ring-offset-0"
        />
...
const LenovoLogo = () => (
  <span className="text-[8px] font-bold text-slate-800 font-sans tracking-wide">lenovo</span>
);
